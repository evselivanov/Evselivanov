# Вторник утро — НОВОЕ деление на 2 трека по ёмкости (2026-08-04)

Причина: старое деление (вся молитва Иоанну = ч.I) не влезло в генерацию (6:43, обрыв на Outro).
Новая граница: ч.I = исповедь (до 2-го припева), ч.II = мольба (литания Иоанну → «вот день» → Христос).
Ч.I: 3775 симв. (~7:00), Ч.II: 3824 симв. (~7:05). Полнота текста сверена: 42/42 предложений.
Suno: настройки прежние (Персона, Style B, 40/80/50), Duration: Custom 8:00 для надёжности.
